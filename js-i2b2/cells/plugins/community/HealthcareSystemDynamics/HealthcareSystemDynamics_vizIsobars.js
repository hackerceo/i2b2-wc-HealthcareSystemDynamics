...
i2b2.HealthcareSystemDynamics.multiIsoBar = {
		...
		for (var i=0; i<data.datagroups.length; i++) {
			switch (data.datagroups[i].type) {
				case "line":
					...
					break;
				case "points":
					if (i2b2.HealthcareSystemDynamics.model.options.ShowPatients) this.drawPoints.call(this, data.datagroups[i]);
					break;
				case "meanPoint":
					if (i2b2.HealthcareSystemDynamics.model.options.ShowMean) this.drawMeanPoint.call(this, data.datagroups[i]);
					break;
				case "ellipse":
					if (i2b2.HealthcareSystemDynamics.model.options.ShowStDev) this.drawEllipse.call(this, data.datagroups[i]);
					break;
			}
		}
		//for (var i=0; i<data.datagroups.length; i++) {
