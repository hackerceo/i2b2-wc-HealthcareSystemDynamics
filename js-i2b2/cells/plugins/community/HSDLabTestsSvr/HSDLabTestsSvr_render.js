...
*/
        ...
        matrix_d3.append("text")
			.attr("class","l2 HSDLabTestsSvr-svgXAxis")
			.attr("x","558.5")
			.attr("y","15")
			.attr("text-anchor","middle");
        matrix_d3.append("text")
            .attr("class","l2 HSDLabTestsSvr-svgYAxis")
            .attr("x","-315.5")
            .attr("y","15")
            .attr("text-anchor","middle")
        ...
        grid_d3.attr('transform','translate(0,0)')
            .classed('HSDLabTestsSvr-grid', true);
		...
		summary.attr('transform','translate(0,575)')
			.classed('HSDLabTestsSvr-SummaryCol', true);
        ...
        summary.attr('transform','translate(973,0)')
            .classed('HSDLabTestsSvr-SummaryRow', true);
