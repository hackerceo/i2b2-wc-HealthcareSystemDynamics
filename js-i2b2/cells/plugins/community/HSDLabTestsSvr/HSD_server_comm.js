...
i2b2.HSDLabTestsSvr.ajax = i2b2.hive.communicatorFactory("HSDLabTestsSvr");

// ================================================================================================== //
i2b2.HSDLabTestsSvr.cfg.msgHSDLabTestsSvr = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>\r'+
    ...
    '			<param type="text" column="hsd_query_type">HSD_GET_LAB</param>' +
    '			<param type="text" column="labtestConceptPath">{{{lab_concept_path}}}</param>' +
    '			<param type="text" column="outcomeConceptPath">{{{outcome_concept_path}}}</param>' +
...
i2b2.HSDLabTestsSvr.ajax._addFunctionCall(	"getLabTestSummary",
    "{{{URL}}}request",
    i2b2.HSDLabTestsSvr.cfg.msgHSDLabTestsSvr,
    ["HSD_Request"]);